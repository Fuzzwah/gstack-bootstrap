...
version: 1.0.0
description: |
  CEO-mode plan review. Rethink the problem, find the 10-star product,
...
## Prime Directives
1. Zero silent failures. Every failure mode must be visible — to the system and to the user. If a failure can happen silently, that is a critical defect in the plan.
